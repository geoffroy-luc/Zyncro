...
class _NoteEditorScreenState extends ConsumerState<NoteEditorScreen> {
  ...
  // Controllers pour les items de checklist
  ...
  void _addChecklistItem() {
    setState(() {
      ...
      // Focus le nouvel item après le build
    ...
    try {
      ...
      if (widget.note == null) {
        ...
        ref.read(messagesRepositoryProvider).sendSystemMessage(
              groupId: groupId,
              userId: user.uid,
              content: '📝 $userName a ajouté une note « $title »',
              notifScreen: 'notes',
            );
      } else {
        ...
        ref.read(messagesRepositoryProvider).sendSystemMessage(
              groupId: groupId,
              userId: user.uid,
              content: '📝 $userName a modifié la note « $title »',
              notifScreen: 'notes',
            );
      }
