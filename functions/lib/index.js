...
exports.onNewExpense =
  exports.onNoteDeleted =
  exports.onNoteUpdated =
  exports.onNoteCreated =
  exports.onEventDeleted =
  exports.onEventUpdated =
  exports.onEventCreated =
  exports.onExpenseUpdated =
  exports.onNewMessage =
  exports.onMemberRemoved =
  exports.onGroupDeleted =
    void 0;
const admin = require("firebase-admin");
const firestore_1 = require("firebase-functions/v2/firestore");
admin.initializeApp();
/** Notifie les membres et supprime toutes les sous-collections quand un groupe est supprimé. */
exports.onGroupDeleted = (0, firestore_1.onDocumentDeleted)(
  "groups/{groupId}",
  async (event) => {
    var _a, _b, _c;
    ...
    const groupData =
      (_a = event.data) === null || _a === void 0 ? void 0 : _a.data();
    const groupName =
      (_b =
        groupData === null || groupData === void 0
          ? void 0
          : groupData.name) !== null && _b !== void 0
        ? _b
        : "le groupe";
    const memberIds =
      (_c =
        groupData === null || groupData === void 0
          ? void 0
          : groupData.memberIds) !== null && _c !== void 0
        ? _c
        : [];
...
exports.onMemberRemoved = (0, firestore_1.onDocumentDeleted)(
  ...
  async (event) => {
    ...
    const groupName =
      (_c =
        (_b = groupDoc.data()) === null || _b === void 0 ? void 0 : _b.name) !==
        null && _c !== void 0
        ? _c
        : "le groupe";
...
exports.onNewMessage = (0, firestore_1.onDocumentCreated)(
  ...
  async (event) => {
    ...
    const memberIds =
      (_e =
        (_d = groupDoc.data()) === null || _d === void 0
          ? void 0
          : _d.memberIds) !== null && _e !== void 0
        ? _e
        : [];
    ...
    await sendNotif(
      tokens,
      (_g = message.senderName) !== null && _g !== void 0
        ? _g
        : "Nouveau message",
      preview,
      groupId,
...
async function getGroupTokens(db, groupId, excludeUid) {
  ...
  const groupName =
    (_b =
      (_a = groupDoc.data()) === null || _a === void 0 ? void 0 : _a.name) !==
      null && _b !== void 0
      ? _b
      : "";
  const memberIds =
    (_d =
      (_c = groupDoc.data()) === null || _c === void 0
        ? void 0
        : _c.memberIds) !== null && _d !== void 0
      ? _d
      : [];
  const tokens = [];
  await Promise.all(
...
exports.onExpenseUpdated = (0, firestore_1.onDocumentUpdated)(
  "groups/{groupId}/expenses/{expenseId}",
  async (event) => {
    var _a, _b, _c, _d, _e, _f, _g;
    const after =
      (_a = event.data) === null || _a === void 0 ? void 0 : _a.after.data();
    if (!after) return;
    const { groupId } = event.params;
    const db = admin.firestore();
    ...
    const actorUid =
      (_c =
        (_b = after.updatedBy) !== null && _b !== void 0
          ? _b
          : after.paidBy) !== null && _c !== void 0
        ? _c
        : "";
    const splitWith =
      (_d = after.splitWith) !== null && _d !== void 0 ? _d : [];
    ...
    const [tokens, groupName] = await Promise.all([
      Promise.all(
        recipients.map(async (uid) => {
          var _a;
          const userDoc = await db.doc(`users/${uid}`).get();
          return (_a = userDoc.data()) === null || _a === void 0
            ? void 0
            : _a.fcmToken;
        }),
    ...
    const actorName = after.updatedBy
      ...
      : (_e = after.paidByName) !== null && _e !== void 0
        ? _e
        : "Quelqu'un";
...
// ── Événements ────────────────────────────────────────────────────────────────
exports.onEventCreated = (0, firestore_1.onDocumentCreated)(
  ...
  async (event) => {
    ...
    const [{ tokens, groupName }, name] = await Promise.all([
      ...
      data.creatorName
        ? Promise.resolve(data.creatorName)
        : getDisplayName(createdBy),
    ]);
    await sendNotif(
      tokens,
      `${name} a créé un événement`,
      (_b = data.title) !== null && _b !== void 0 ? _b : "Événement",
      groupId,
      "calendar",
      groupName,
    );
...
exports.onEventUpdated = (0, firestore_1.onDocumentUpdated)(
  "groups/{groupId}/events/{eventId}",
  async (event) => {
    var _a, _b, _c, _d;
    const after =
    ...
    const db = admin.firestore();
    const actorUid =
      (_b = after.updatedBy) !== null && _b !== void 0 ? _b : after.createdBy;
    const [{ tokens, groupName }, name] = await Promise.all([
      getGroupTokens(db, groupId, actorUid),
      actorUid === after.createdBy
        ? Promise.resolve(
            (_c = after.creatorName) !== null && _c !== void 0 ? _c : null,
          ).then((n) =>
            n !== null && n !== void 0 ? n : getDisplayName(actorUid),
          )
        : getDisplayName(actorUid),
    ]);
    await sendNotif(
      tokens,
      `${name} a modifié un événement`,
      (_d = after.title) !== null && _d !== void 0 ? _d : "Événement",
      groupId,
      "calendar",
      groupName,
    );
...
exports.onEventDeleted = (0, firestore_1.onDocumentDeleted)(
  "groups/{groupId}/events/{eventId}",
  async (event) => {
    var _a, _b;
    const before =
    ...
    const [{ tokens, groupName }, name] = await Promise.all([
      ...
      before.creatorName
        ? Promise.resolve(before.creatorName)
        : getDisplayName(createdBy),
    ]);
    await sendNotif(
      tokens,
      `${name} a supprimé un événement`,
      (_b = before.title) !== null && _b !== void 0 ? _b : "Événement",
      groupId,
      "calendar",
      groupName,
    );
...
// ── Notes ─────────────────────────────────────────────────────────────────────
exports.onNoteCreated = (0, firestore_1.onDocumentCreated)(
  ...
  async (event) => {
    ...
    await sendNotif(
      tokens,
      `${name} a créé une note`,
      (_b = data.title) !== null && _b !== void 0 ? _b : "Note",
      groupId,
      "notes",
      groupName,
    );
...
exports.onNoteUpdated = (0, firestore_1.onDocumentUpdated)(
  "groups/{groupId}/notes/{noteId}",
  async (event) => {
    var _a, _b, _c, _d;
    const before =
    ...
    const db = admin.firestore();
    const actorUid =
      (_c = after.updatedBy) !== null && _c !== void 0 ? _c : after.createdBy;
    const [{ tokens, groupName }, name] = await Promise.all([
      getGroupTokens(db, groupId, actorUid),
      getDisplayName(actorUid),
    ]);
    await sendNotif(
      tokens,
      `${name} a modifié une note`,
      (_d = after.title) !== null && _d !== void 0 ? _d : "Note",
      groupId,
      "notes",
      groupName,
    );
...
exports.onNoteDeleted = (0, firestore_1.onDocumentDeleted)(
  "groups/{groupId}/notes/{noteId}",
  async (event) => {
    var _a, _b;
    const before =
    ...
    await sendNotif(
      tokens,
      `${name} a supprimé une note`,
      (_b = before.title) !== null && _b !== void 0 ? _b : "Note",
      groupId,
      "notes",
      groupName,
    );
...
exports.onNewExpense = (0, firestore_1.onDocumentCreated)(
  "groups/{groupId}/expenses/{expenseId}",
  async (event) => {
    ...
    const splitWith =
      (_b = expense.splitWith) !== null && _b !== void 0 ? _b : [];
    ...
    if (tokens.length === 0) return;
    const paidByName =
      (_d = expense.paidByName) !== null && _d !== void 0 ? _d : "Quelqu'un";
    const title =
      (_e = expense.title) !== null && _e !== void 0 ? _e : "Nouvelle dépense";
